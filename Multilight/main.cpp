...
int main()
{
    ...
    // -------------------------
    Shader lightingShader("/home/user/learnopengl/project/Multilight/3.3.shader.vs", "/home/user/learnopengl/project/Multilight/multilight.fs");
    Shader lightCubeShader("/home/user/learnopengl/project/Multilight/light_shader.vs", "/home/user/learnopengl/project/Multilight/light_shader.fs");
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = loadTexture("/home/user/learnopengl/project/Multilight/container2.png");
    unsigned int specularMap = loadTexture("/home/user/learnopengl/project/Multilight/container2_specular.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("flashlight.outerCutOff",glm::cos(glm::radians(13.0f)));
        ...
        lightingShader.setVec3("flashlight.diffuse", 0.8f, 0.8f, 0.0f);
        lightingShader.setVec3("flashlight.specular", 0.8f, 0.8f, 0.0f);
